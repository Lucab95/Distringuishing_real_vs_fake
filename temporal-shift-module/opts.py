...
parser.add_argument('-dataset', type=str, default='sasefe', choices=['ucf101', 'hmdb51', 'kinetics',"sasefe"])
...
parser.add_argument('--lr', '--learning-rate', default=0.00125, type=float,
